  ...
  // println("Yaw");
   // println( handYaw);
     ...
     // println(handGrab);
      ...
      //println(handStabilized);
   // if (handPosition.x > 680) {
     // angle = 180;
  //  } else if (handPosition.x < 0) {
    //  angle = 0;
  //  } else {
   //   angle = int((handPosition.x) / 3.77);
   // }
   if(handYaw < -2 )
   {
   ...
   // println(angle);
    ...
    //println(fingerVelocity);
      ...
      PVector uiui = fingerIndex.getPosition();
